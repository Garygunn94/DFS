...
data DirectoryServer = DirectoryServer { address :: String, port :: String }

--Constructor
newDirectoryServer :: String -> String -> IO DirectoryServer
newDirectoryServer address port = atomically $ do DirectoryServer <$> return address <*> return port 
